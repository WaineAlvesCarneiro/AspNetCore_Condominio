...
public class CreateMoradorCommandValidatorTests
{
    private readonly CreateMoradorCommandValidator _validator = new();
    ...
    {
        var command = GetValidCommand();
        command.DataEntrada = DateOnly.FromDateTime(DateTime.Today.AddDays(1));
        var resultado = _validator.TestValidate(command);
